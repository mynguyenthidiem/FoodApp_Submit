...
const TYPE_META = {
  0: { icon: "clipboard-check-outline", color: COLORS.primary, bg: COLORS.secondary, actionLabel: "Track Order" }, // OrderCreated
  1: { icon: "truck-delivery-outline", color: COLORS.tertiary, bg: "#DAF3F8", actionLabel: "Track Order" }, // OrderStatusChanged
  2: { icon: "check-circle-outline", color: COLORS.success, bg: "#E1F3E1", actionLabel: null }, // PaymentCompleted
  3: { icon: "star-outline", color: COLORS.warning, bg: "#FFF3D6", actionLabel: null }, // NewReview
  4: { icon: "information-outline", color: COLORS.neutral, bg: COLORS.surfaceContainerLow, actionLabel: null }, // System
};
